...
PHRASES = {
    "class %%%(%%%):": "Создается класс с именем %%%, наследующим %%%.",
    "class %%%(object):\n\tdef __init___(self, ***)" : "Клас %%% комбинирует __init__ с параметрами self и параметрами ***.",
    "class %%%(object):\n|tdef ***(self, @@@)" : 
    "Класс %%% комбинирует функцию с именем *** с параметрами self и @@@", 
    "*** = %%%()" : "Создается *** как экземпляр класса %%%.", 
    "***.***(@@@)" : "Из *** получается функция ***б а затем вызывается с параетрами Self, @@@.",
